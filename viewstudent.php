...
if ($page == 'thisappointment') {
    ...
    $table->head  = array ($strdate, $strstart, $strend, $strseen, $strnote, get_string('studentcomments', 'scheduler'), $strgrade, s(scheduler_get_teacher_name($scheduler)));
    ...
    foreach ($slots as $otherslot) {
        ...
        $table->data[] = array ($datelink, $starttime, $endtime, $attendedpix,
                                 $otherslot->appointmentnote, $otherslot->studentteachernotes, $grade, fullname($teacher));
    }
    ...
    $table->head  = array($strname, $strseen, $strnote, get_string('studentcomments', 'scheduler'), $strgrade);
