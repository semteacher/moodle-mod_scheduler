...
$string['addaperiodsession'] = 'Додати інтервали - вільно';//@TDMU
$string['addsession'] = 'Додати інтервали - щотижня';//@TDMU renamed
$string['addsingleslot'] = 'Додати один інтервал';
...
$string['studentcomments'] = 'Примітки студентів'; //@TDMU renamed
...
$string['studentnotesrequired']='Налаштування режиму вимог для приміток студнентів';// @TDMU
