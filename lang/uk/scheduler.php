...
$string['appointmentno'] = 'Графік прийому {$a}';
...
$string['ignoreconflicts'] = 'Ігнорувати перекривання розкладів';
...
$string['maxstudentlistsize'] = 'Максимальна довжина переліку студентів';
$string['maxstudentlistsize_desc'] = 'Максимальна довжина переліку студентів, що потребують розкладу прийому, що буде відображена у панелі викладача. Якщо студентів більше, список не буде відображено.';
...
$string['slotwarning'] = '<strong>Попередження: </strong>Переміщення цього інтервалу на вибраний час вимагає щоб наступний(і) інтервал(и) був(ли) переміщений(і)...';
