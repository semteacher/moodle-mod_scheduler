...
$string['addaperiodsession'] = 'Ajouter des créneaux - libre';//@TDMU
$string['addsession'] = 'Ajouter des créneaux - chaque semaine';//@TDMU-renamed
...
$string['defaultschedulername'] = 'Par le travail';//@TDMU
