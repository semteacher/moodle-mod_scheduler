...
class scheduler_editslot_form extends scheduler_slotform_base {
    ...
    public function validation($data, $files) {
        ...
        if (!isset($data['ignoreconflicts'])) {
            ...
            $conflictsremote = scheduler_get_conflicts($this->scheduler->id, $data['starttime'], $data['starttime'] + $data['duration'] * 60, $data['teacherid'], 0, SCHEDULER_OTHERS, $exclusive_condition);            
