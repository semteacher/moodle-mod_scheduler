...
//        $mform->addElement('advcheckbox', 'sunday', '', get_string('sunday', 'scheduler'));
        ...
        $mform->addElement('html', '<script type="text/javascript" src="'.$CFG->wwwroot.'/mod/scheduler/scripts/jquerydatepick406/jquery.datepick.js">
</script>');
        $mform->addElement('html', '<script type="text/javascript" src="'.$CFG->wwwroot.'/mod/scheduler/scripts/jquerydatepick406/jquery.datepick.lang.js">
</script>');
